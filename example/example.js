...
// const label = '02869D'
const consumer = "99.247.136.70-0002-05"
...
const build = () => {
	let label = labels[Math.round(Math.random() * (labels.length - 0) + 0)]
	...
	console.log(`task token=${token} label=${label} data-len=${task_bytes.length}`)
